// components/mall/ConfirmationDialogs.tsx
"use client"
...
import { saveMallFormDraft, clearMallFormDraft } from "@/lib/mall-form-persistence"
...
export function ConfirmationDialogs({ mode, hasUnsavedChanges, formData, onClose, isSubmitting, onResetForm, isModalOpen }: ConfirmationDialogsProps) {
  ...
  useEffect(() => {
    ...
    ;(window as any).handleMallFormClose = handleCloseAttemptFromParent
    
    return () => {
      delete (window as any).handleMallFormClose
    }
