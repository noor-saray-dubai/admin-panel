// components/building/ConfirmationDialogs.tsx
"use client"
...
import { saveBuildingFormDraft, clearBuildingFormDraft } from "@/lib/building-form-persistence"
...
export function ConfirmationDialogs({ mode, hasUnsavedChanges, formData, onClose, isSubmitting, onResetForm, isModalOpen }: ConfirmationDialogsProps) {
  ...
  useEffect(() => {
    ...
    ;(window as any).handleBuildingFormClose = handleCloseAttemptFromParent
    
    return () => {
      delete (window as any).handleBuildingFormClose
    }
