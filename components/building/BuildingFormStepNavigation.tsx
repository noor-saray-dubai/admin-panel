// components/building/BuildingFormStepNavigation.tsx
"use client"
...
interface BuildingFormStepNavigationProps {
  steps: Step[]
  currentStep: number
...
export function BuildingFormStepNavigation({
  steps,
  currentStep,
  onStepClick,
  getStepStatus
}: BuildingFormStepNavigationProps) {
  return (
