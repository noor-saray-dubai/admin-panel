// components/project/ProjectFormStepNavigation.tsx
"use client"
...
export interface StepValidationStatus {
  [stepIndex: number]: 'valid' | 'invalid' | 'incomplete' | 'pending'
}

interface ProjectFormStepNavigationProps {
  steps: ProjectStep[]
  currentStep: number
...
export function ProjectFormStepNavigation({ 
  steps, 
  currentStep, 
  onStepClick,
  validationStatus 
}: ProjectFormStepNavigationProps) {
  const getStepStatus = (stepIndex: number) => {
    return validationStatus[stepIndex] || 'incomplete'
  }
